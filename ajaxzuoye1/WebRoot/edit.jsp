...
<body>
	...
	<div class="content">
		...
		<form action="StaffEdit" method="post">
			<div>
				<label>编号</label>
				<input name="id" value="${param.id }" readonly="readonly"><span>只读</span>
			</div>
			<div>
				<label>姓名</label>
				<input name="name" value="${param.name }" readonly="readonly"><span>只读</span>
			</div>
			<div>
				<label>职位</label>
				<select name="job" value="${param.job }">
